...
class AtendimentosDiabetes(models.Model):
    ...
    cgc_hosp = models.FloatField(db_column='CGC_HOSP', blank=True, null=True)  # Field name made lowercase.
    ...
    num_proc = models.FloatField(db_column='NUM_PROC', blank=True, null=True)  # Field name made lowercase.
    ...
    cpf_aut = models.FloatField(db_column='CPF_AUT', blank=True, null=True)  # Field name made lowercase.
    ...
    gestor_dt = models.FloatField(db_column='GESTOR_DT', blank=True, null=True)  # Field name made lowercase.
    cnes = models.BigIntegerField(db_column='CNES', blank=True, null=True)  # Field name made lowercase.
    cnpj_mant = models.FloatField(db_column='CNPJ_MANT', blank=True, null=True)  # Field name made lowercase.
    infehosp = models.FloatField(db_column='INFEHOSP', blank=True, null=True)  # Field name made lowercase.
    ...
    faec_tp = models.FloatField(db_column='FAEC_TP', blank=True, null=True)  # Field name made lowercase.
    ...
    res_latitude = models.FloatField(db_column='RES_LATITUDE', blank=True, null=True)  # Field name made lowercase.
    res_longitude = models.FloatField(db_column='RES_LONGITUDE', blank=True, null=True)  # Field name made lowercase.
    res_altitude = models.FloatField(db_column='RES_ALTITUDE', blank=True, null=True)  # Field name made lowercase.
    res_area = models.FloatField(db_column='RES_AREA', blank=True, null=True)  # Field name made lowercase.
    ...
    int_latitude = models.FloatField(db_column='INT_LATITUDE', blank=True, null=True)  # Field name made lowercase.
    int_longitude = models.FloatField(db_column='INT_LONGITUDE', blank=True, null=True)  # Field name made lowercase.
    int_altitude = models.BigIntegerField(db_column='INT_ALTITUDE', blank=True, null=True)  # Field name made lowercase.
    int_area = models.FloatField(db_column='INT_AREA', blank=True, null=True)  # Field name made lowercase.
    ...
    def_idade_anos = models.FloatField(db_column='DEF_IDADE_ANOS', blank=True, null=True)  # Field name made lowercase.
    def_idade_meses = models.FloatField(db_column='DEF_IDADE_MESES', blank=True, null=True)  # Field name made lowercase.
    def_idade_dias = models.FloatField(db_column='DEF_IDADE_DIAS', blank=True, null=True)  # Field name made lowercase.
    ...
    def_diag_secun_cap = models.FloatField(db_column='DEF_DIAG_SECUN_CAP', blank=True, null=True)  # Field name made lowercase.
    def_diag_princ_grupo = models.TextField(db_column='DEF_DIAG_PRINC_GRUPO', blank=True, null=True)  # Field name made lowercase.
    def_diag_secun_grupo = models.FloatField(db_column='DEF_DIAG_SECUN_GRUPO', blank=True, null=True)  # Field name made lowercase.
    def_diag_princ_cat = models.TextField(db_column='DEF_DIAG_PRINC_CAT', blank=True, null=True)  # Field name made lowercase.
    def_diag_secun_cat = models.FloatField(db_column='DEF_DIAG_SECUN_CAT', blank=True, null=True)  # Field name made lowercase.
    def_diag_princ_subcat = models.TextField(db_column='DEF_DIAG_PRINC_SUBCAT', blank=True, null=True)  # Field name made lowercase.
    def_diag_secun_subcat = models.FloatField(db_column='DEF_DIAG_SECUN_SUBCAT', blank=True, null=True)  # Field name made lowercase.
    ...
    def_infehosp = models.FloatField(db_column='DEF_INFEHOSP', blank=True, null=True)  # Field name made lowercase.
